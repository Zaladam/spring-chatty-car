...
public interface TripsProxy {
  ...
  @GetMapping("/trips")
  Iterable<Trip> getListOfTrips(
      @RequestParam(name = "departure_date", required = false) String departureDate,
  ...
  Iterable<Trip> getListOfTripOfDriver(@PathVariable int driverId);
